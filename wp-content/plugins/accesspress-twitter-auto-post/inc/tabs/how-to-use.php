<div class="asap-section" id="asap-section-how" <?php if ($active_tab != 'how') { ?>style="display: none;"<?php } ?>>
    ...
    <p>You can get all these details after creating a Twitter Application <a href="https://apps.twitter.com/" target="_blank">here</a>.And please make sure you keep <input type="text" readonly="readonly" value="<?php echo site_url(); ?>" onfocus="this.select();" style="width: 100%;"/> as Website URL while creating the app.</p>
