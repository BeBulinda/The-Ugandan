            				...
            				<div class="text-holder">
            					...
            					<header class="entry-header">
            						...
            						<div class="entry-meta">
            							<span><?php echo esc_html( numinous_relative_time( get_the_date() ) ); ?></span>
            						</div>
            					</header>
            				</div>
            			</div>
...
function numinous_footer_bottom(){
    ...
    <div class="footer-b">
		<div class="container">
			<div class="site-info">
				<span class="copyright"><?php echo esc_html__( '&copy; Copyright ', 'numinous' ) . date_i18n('Y'); ?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></a>.</span>
				<span class="by">
