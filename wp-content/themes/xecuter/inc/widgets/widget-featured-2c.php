...
add_action( 'widgets_init', 'register_xecuter_featured_2c' );
 function register_xecuter_featured_2c() {
    register_widget( 'xecuter_featured_2c' );
}

class xecuter_featured_2c extends WP_Widget {
