...
$main_menu_rtl = is_rtl() ? 'right':'left';

$of_options[] = array( "name" 		=> esc_html__('Main Menu Alignment', 'xecuter' ),
						"id" 		=> "xecuter_main_menu_align",
 						"std" 		=>  $main_menu_rtl,
 						"type" 		=> "select",
						"options" 	=> array(	'left' 		=> esc_html__('Left', 'xecuter' ),
												'right' 	=> esc_html__('Right', 'xecuter' ),
 											)
				); 
...
$of_options[] = array( "name" 		=> esc_html__('Top Menu Alignment', 'xecuter' ),
