...
function xecuter_category_fields( $tag ) {	//check for existing featured ID
	...
	<tr class="form-field rd-category meta_xecuter_body_background_color meta_xecuter_color">
      	<th scope="row" class="row-cats" valign="top"><label class="row-cats" for="meta_xecuter_body_background_color"><?php echo esc_html__('Background Type','xecuter');?></label></th>
		<td>
