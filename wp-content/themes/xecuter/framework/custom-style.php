...
function xecuter_custom_css() {
	...
	// Body Background
 	if(!empty($meta['xecuter_body_background_color'])){
	...
	$css='body {';
		...
		if ( !empty( $smof_data[ 'xecuter_body_font_family' ] ) ) { 
			$css.='font-family:'.esc_html($smof_data['xecuter_body_font_family']).';';
		
		} elseif(!empty( $smof_data[ 'xecuter_body_google_font_family' ]) ){
			$css.='font-family:'.esc_html( $smof_data['xecuter_body_google_font_family']).', sans-serif;';
		}/* latin */
 
		
	$css.='}';
	
	if (  empty( $smof_data[ 'xecuter_body_font_family' ]) || empty($smof_data[ 'xecuter_body_google_font_family' ]) || !is_rtl()  ) { 
		$css.="@font-face {
				  font-family: 'Roboto';
				  font-style: normal;
				  font-weight: 400;
	...
	/**---------------------------- logo ----------------------------**/ 
 	...
 	$css.='a.rd-logo-title ,a.rd-logo-description{';
		...
		if ( !empty( $smof_data[ 'xecuter_logo_font_family' ] ) ) { 
 			$css.='font-family:'.esc_html(  $smof_data['xecuter_logo_font_family']).';';
	
		} elseif(!empty( $smof_data[ 'xecuter_logo_google_font_family' ]) ){
 			$css.='font-family:'.esc_html(  $smof_data['xecuter_logo_google_font_family']).' , sans-serif;';
